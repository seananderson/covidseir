...
m <- fit_seeiqr(d$cases, iter = 250, chains = 6)
```
...
The rstan object itself is in the named element `fit`:
...
It's helpful to know that the data, exactly as it was passed to Stan, are in the element `stan_data`:
