...
m <- fit_seir(d$cases, iter = 200, chains = 6)
...
m2 <- fit_seir(cbind(d$cases, hosp), iter = 125, chains = 6,
...
m_forecast <- fit_sirbayes(d$cases, iter = 500, chains = 1, forecast_days = 60)
```
