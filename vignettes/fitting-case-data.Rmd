...
We can also calculate the threshold for expected increases in prevalence. We estimate the threshold by determining which f value gives a 0 rate of growth using the following procedure (Anderson et al., In press at PLOS Computational Biology):
